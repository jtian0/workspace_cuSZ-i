...
COR::compress_encode(pszctx* ctx, void* stream)
{
  ...
  /* Huffman encoding */
  {
    ...
    //   printf("Error: Huffman compression failed, output buffer is null\n");
    //   return nullptr;
    // }
    
    // Check if the pointer is 4-byte aligned
    // if ((uintptr_t)comp_hf_out % 4 != 0) {
    //   printf("Error: Huffman compressed output is not 4-byte aligned\n");
    //   return nullptr;
    // }
