...
class Compressor {
 ...
 private:
  ...
  float time_pred, time_hist, time_sp, time_difflog;
  ...
  BYTE* comp_difflog_out{nullptr};
  size_t comp_difflog_outlen{0};
  size_t difflog_padding_bytes{0};
 ...
 public:
  ...
  Compressor* compress_difflog(pszctx*, uninit_stream_t);
  ...
  Compressor* decompress_difflog(pszheader*, BYTE*, uninit_stream_t);
