...
add_library(fasthuff src/fasthuff/testhuff.cu src/fasthuff/huffman_coarse.cu src/fasthuff/huffman_parbook.cu)
target_link_libraries(fasthuff PUBLIC pszcompile_settings CUDA::cudart CUDA::cusparse)
set_target_properties(fasthuff PROPERTIES CUDA_SEPARABLE_COMPILATION ON)

add_library(cusz src/cusz_lib.cc)
target_link_libraries(cusz PUBLIC pszcomp_cu pszhf_cu pszspv_cu pszstat_seq
                                  pszutils_seq pszmem rtr fasthuff)
...
install(TARGETS fasthuff EXPORT CUSZTargets LIBRARY DESTINATION ${CMAKE_INSTALL_LIBDIR})
